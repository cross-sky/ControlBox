...
#define ADCInputAC	1
const IOControl adcInput[ADCInputAC]={
	{0, NTCPINAs, GPIOA,RCC_APB2Periph_GPIOA},	//pinas
};

//channel 序号以adc01-09所使用的引脚为准
uint8_t tabChannel[ADCMAX]={
	ADC_Channel_0, ADC_Channel_1, ADC_Channel_4,ADC_Channel_5,
	ADC_Channel_6, ADC_Channel_7, ADC_Channel_16
...
void vADCInit(void)
{
	...
	for (name=0; name<ADCInputAC; name++)
	{
